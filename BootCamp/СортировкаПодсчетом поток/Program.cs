...
Array.Copy(resSerial, resParallel, N); // Беру из resSerial вставляю в resParallel N-элементов.
...
void PrepareParallelCountingSort(int[] inputArray)
{
    ...
    var threadsParall = new List<Thread>(); // Создаем Массив - Коллекция или Список.
